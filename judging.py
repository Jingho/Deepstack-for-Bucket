...
def judging(handnum1, handnum2, community):
    community_new = hand_to_numeric(community)
    handnum1_new = hand_to_numeric(handnum1)
    handnum2_new = hand_to_numeric(handnum2)
    best_hand1 = best_five(handnum1_new, community_new)
    #print(best_hand1)
    best_hand2 = best_five(handnum2_new, community_new)
